...
const { runAgentLoop } = require('../../api/_lib/agent-loop');
const { buildStateContext, getTeamPrompt, syncFromAgentLoop } = require('../../api/_lib/agent-state');
const { checkCreditLimits } = require('../../api/_lib/world-controller');
const {
  authenticate,
  getCorsOrigin,
  getRequestHost,
...
module.exports = async (req, res) => {
  ...
  // Authenticate
  const authResult = authenticate(req, process.env.ADMIN_TOKEN);
